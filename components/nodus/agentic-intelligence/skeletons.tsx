...
import {
  ...
  SlackLogo,
  SupabaseLogo,
} from "@/components/nodus/icons/general";
import {
  DatabaseIcon,
  CheckIcon,
  BellIcon,
...
export const LLMModelSelectorSkeleton = () => {
  const t = useTranslations("Marketing.skeletons.voiceAi");
  const models = [
    {
      name: t("guest1Name"),
      logo: PhoneIcon,
    ...
    <motion.div className="relative mx-auto mt-20 h-full max-h-70 min-h-40 w-[85%] rounded-2xl border-t border-gray-300 bg-white p-4 shadow-2xl dark:border-neutral-700 dark:bg-neutral-800">
      ...
      >
        <div className="flex w-full items-center justify-between p-2">
          ...
          <p className="font-mono text-gray-600">{t("active")}</p>
        </div>
        <DivideX />
...
export const TextToWorkflowBuilderSkeleton = () => {
  const t = useTranslations("Marketing.skeletons.whatsapp");
  const initialChat = [
    {
      role: "assistant",
      content: t("message1"),
...
export const NativeToolsIntegrationSkeleton = () => {
  const t = useTranslations("Marketing.skeletons.seating");
  return (
    <>
      ...
      <motion.div className="relative mx-auto my-12 hidden h-full max-h-70 min-h-80 max-w-244 grid-cols-2 p-4 lg:grid">
        <div className="flex items-center justify-between">
          <div className="flex flex-col gap-10">
            <TextIconBlock icon={<DatabaseIcon className="size-5" />} text={t("guestList")}>
              <TopSVG className="absolute top-2 -left-84" />
            </TextIconBlock>
            <TextIconBlock icon={<CheckIcon className="size-5" />} text={t("rsvpTracking")}>
              <MiddleSVG className="absolute top-2 -left-84" />
            </TextIconBlock>
            <TextIconBlock icon={<BellIcon className="size-5" />} text={t("notifications")}>
              <BottomSVG className="absolute bottom-2 -left-84" />
            </TextIconBlock>
          </div>
        ...
        <div className="relative flex h-full w-full items-center justify-start">
          ...
          <div className="2 absolute -top-2 left-30 flex h-full flex-col items-center">
            <IconBlock icon={<BellIcon className="size-6" />} />
            <VerticalLine />
            <IconBlock icon={<CheckIcon className="size-6" />} />
          </div>
          <RightSideSVG />
          <IconBlock icon={<GraphIcon className="size-6" />} />
        </div>
      </motion.div>
    </>
  );
